...
class LobbyItems extends PluginBase implements Listener
{
	...
	*/
	...
	public function onEnable(): void{
		...
		$this->getLogger()->info(TextFormat::GREEN . "Plugin has enabled by zGodSky.");
	...
	public function onPreLogin(PlayerPreLoginEvent $event)
	{
		...
		if (!$player->isWhitelisted($name)) {
			$msg =
				...
				TextFormat::RESET . TextFormat::GOLD . "EnjoyTheView" . TextFormat::GRAY . "|" . TextFormat::RED . " WhiteListed\n" .
...
$this->getLogger()->info($this->prefix."§cDas kann nur ein Spieler");
		...
		//GroeÃŸe
		if($in == TextFormat::RESET . TextFormat::GOLD . "GroeÃŸen") {
		...
		if($in == TextFormat::RESET . TextFormat::GOLD . "GroÃŸ") {
			
			$player->sendMessage($this->prefix . TextFormat::GREEN . "Du bist jetzt " . TextFormat::GOLD . "GroÃŸ");
