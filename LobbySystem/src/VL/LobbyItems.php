...
class LobbyItems extends PluginBase implements Listener
{
	...
	*/
	...
	public function getTeleporter(Player $player)
	{
		...
		$Hub 1 = Item::get(42,1, 1);
		$Hub 1->setCustomName(TextFormat::RESET . TextFormat::BLUE . "Hub 1");
	...
	public function getLobbys(Player $player)
	{
		...
		$lobby1->setCustomName(TextFormat::GRAY . "MiniGames" . TextFormat::BOLD . TextFormat::GOLD . "1");
		...
		$prelobby->setCustomName(TextFormat::GOLD . "CityBuild");

		$exit = Item::get(351, 1, 1);
		$exit->setCustomName(TextFormat::RESET . TextFormat::RED . "Exit");

		$inv->setItem(0, $CityBuild);
		$inv->setItem(1, $MiniGames);
		$inv->setItem(7, $Bald);
	...
	public function onInteract(PlayerInteractEvent $event)
	{
		...
		//run
		if ($in == TextFormat::RESET . TextFormat::RED . "Hub 1") {
